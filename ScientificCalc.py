...
# Now we will create a class in which we will create
# all the functions of the scientific calculator
# so that they can be called and perform easily
class Calc():
    def __init__(self):
        self.total =0
        self.current = ''
...
# Now, we generate a display in the GUI of the calculator
# by passing the font style, font size, background color
# foreground color, as an argument inside the entry function
...
# Now we create a number pad for the calculator

# Store all the numbers in a variable
numberpad = "789456123"

# Count the rows for placing buttons in grid
i = 0

# Create an empty list to store
# each button with its particular specs
btn = []


# j is in that range to place the button
...
btndeg = Button(calc, text="deg",width=6, 
                height=2,bg='black',fg='white',
                font=('Helvetica',20,'bold'),
                bd=4,command=added_value.degrees # type: ignore
